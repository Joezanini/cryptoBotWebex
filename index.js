...
//let responded = false;
  ...
  /* On mention with crypto coin example.
  ...
  */
  ...
  function get_bitcoin(bot) {
    ...
    request(options, function (error, response, body) {
      ...
      bot.say("markdown", "The price of BTC is $" + JSON.stringify(json["bitcoin"]["usd"]));
    });
  }
...
let coinCard = {
  ...
  "body": [
      {
          "type": "TextBlock",
          "text": "Crypto Selector",
          "size": "Large",
          "weight": "Bolder"
      },
      {
          "type": "TextBlock",
          "text": "Select Coin From List",
          "isSubtle": true,
          "spacing": "None"
      },
      {
  ...
  */
  framework.hears('coin me', function (bot, trigger) {
    console.log("someone asked for a card");
    responded = true;
    bot.sendCard(coinCard, 'This is customizable fallback text for clients that do not support buttons & cards');
  });
  ...
  framework.hears('reply', function (bot, trigger) {
    ...
    */
    ...
    var server = app.listen(config.port, function () {
      console.log('framework listening on port : ', config.port);
